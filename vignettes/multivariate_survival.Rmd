...
- Know that Kaplan-Meier and associated log-rank test are applicable only to categorical variables.
- Know that Cox regression can be applied to *univariate* or *multivariate* data with either categorical or continuous predictors.
